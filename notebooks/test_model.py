...
model.load_state_dict(torch.load("btc_model_weights_params2.pth"))

with open("Tests_weights_btc.log", "w") as f:
    sys.stdout = f
    ...
    for file_name in os.listdir(directory_path):
        ...
        if file_name.endswith(".npy") and ("ETH" in file_name or "BTC" in file_name
            ...
            with torch.no_grad():
                ...
                acc = 100* (predicted ==y_tst_t).sum()/y_tst_t.shape[0]

                print(f"accuracy of model at {key} --> {acc}")   
